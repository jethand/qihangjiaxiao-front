        ...
        <Card>
            ...
            <div>
                ...
                >
                    ...
                    <div>
                        <Button type="primary" style="width: 100px;" @click="goToHomePage">返回主页</Button>
...
export default {
    ...
    methods: {
        ...
        init () {
            this.userForm.name = this.$store.state.app.userInfo.user_name;
            this.userForm.cellphone = '---';
            this.initPhone = '17712345678';
            this.userForm.company = '启航驾校';
            this.userForm.department = '启航驾校管理中心';
        },
        cancelInputCodeBox () {
